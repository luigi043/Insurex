...
{
    public class AccountReceivable_Asset
    {
        public int iAccountReceivable_Asset_Id { get; set; }
        ...
        public int iAccountReceivable_Asset_Type_Id { get; set; }
        public string iAccountReceivable_Asset_Type_Description { get; set; }
        public string vcAccountReceivable_Description { get; set; }
