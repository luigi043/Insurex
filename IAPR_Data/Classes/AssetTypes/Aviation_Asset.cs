...
{
    public class Aviation_Asset
    {
        public int iAviation_Asset_Id { get; set; }
        ...
        public int iAviation_Asset_Type_Id { get; set; }
        public string vcAviation_Asset_Type_Decsription { get; set; }
        public string vcTail_Number { get; set; }
