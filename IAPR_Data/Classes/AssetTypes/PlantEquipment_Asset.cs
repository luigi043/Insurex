...
{
    public class PlantEquipment_Asset
    {
        public int iPlantEquipment_Asset_Id { get; set; }
        ...
        public int iPlantEquipment_Asset_Type_Id { get; set; }
        public string vcPlantEquipment_Asset_Type_Decsription { get; set; }
