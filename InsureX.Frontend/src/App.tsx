  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Protected Routes – MainLayout handles the auth guard */}
        ...
        {/* Fallback: / → /dashboard (MainLayout will redirect to /login if not auth'd) */}
        <Route path="/" element={<Navigate to="/dashboard" replace />} />
        <Route
          path="*"
          element={
            <div className="flex items-center justify-center min-h-screen text-2xl font-bold text-gray-300">
              404 | Not Found
            </div>
          }
        />
